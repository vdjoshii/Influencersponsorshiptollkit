...
import com.prxy.influencer_sponsorship_app.DTO.AddMarketingBudgetRequest;
...
public class BrandController {
    ...
    @PatchMapping("/{id}/marketing-budget")
    public ResponseEntity<Brand> addMarketingBudget(
            @PathVariable int id,
            @Valid @RequestBody AddMarketingBudgetRequest request
    ) {
        return ResponseEntity.ok(brandService.addMarketingBudget(id, request.getAmount()));
    }
}